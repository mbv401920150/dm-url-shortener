...
internal class TokenRangeManager
{
    ...
    public async Task<TokenRangeResponse> AssignRangesAsync(string machineIdentifier)
    {
        ...
        {
            return new TokenRangeResponse(reader.GetInt64(2), reader.GetInt64(3));
        }
        
        throw new FailedToAssignRangeException("Failed to assign ranges");
    }
}